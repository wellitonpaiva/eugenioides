...
data class CoffeeDrinkingPlace(
    val drinkAtHome: Boolean,
    val drinkAtOffice: Boolean,
    val drinkOnTheGo: Boolean,
    val drinkAtCafe: Boolean,
    val drinkAtOther: Boolean,
    val brewAtHome: String,
    ...
    constructor(map: Map<String, String>) : this(
        drinkAtHome = map["Where do you typically drink coffee? (At home)"].toBoolean(),
        drinkAtOffice = map["Where do you typically drink coffee? (At the office)"].toBoolean(),
        drinkOnTheGo = map["Where do you typically drink coffee? (On the go)"].toBoolean(),
        drinkAtCafe = map["Where do you typically drink coffee? (At a cafe)"].toBoolean(),
        drinkAtOther = map["Where do you typically drink coffee? (None of these)"].toBoolean(),
        brewAtHome = map["How do you brew coffee at home?"].toString(),
